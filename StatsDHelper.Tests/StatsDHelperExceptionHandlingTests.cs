...
//            statsDClient.Stub(o => o.LogCount(Arg<string>.Is.Anything, Arg<int>.Is.Anything, Arg<KeyValuePair<string, string>[]>.Is.Anything)).Throw(new Exception());
...
//            statsDClient.Stub(o => o.LogGauge(Arg<string>.Is.Anything, Arg<int>.Is.Anything, Arg<KeyValuePair<string, string>[]>.Is.Anything)).Throw(new Exception());
...
//            statsDClient.Stub(o => o.LogTiming(Arg<string>.Is.Anything, Arg<int>.Is.Anything, Arg<KeyValuePair<string, string>[]>.Is.Anything)).Throw(new Exception());
...
//            statsDClient.Stub(o => o.LogSet(Arg<string>.Is.Anything, Arg<int>.Is.Anything, Arg<KeyValuePair<string, string>[]>.Is.Anything)).Throw(new Exception());
